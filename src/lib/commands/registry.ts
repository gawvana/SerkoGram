...
export const UNIFIED_COMMANDS: UnifiedCommandDefinition[] = [
  ...
  },
  {
    ...
    prefix: '.',
    title: 'Мут участника',
    description: 'Ограничение отправки сообщений для участника в группе при наличии прав администратора',
    category: 'utility',
    usage: '.mute [время]',
    example: '.mute 10m',
    enabled: true,
    ...
    requiresAI: false,
    requiresMedia: false,
    requiredPermissions: ['can_restrict_members'],
    responseMode: 'SAME_CHAT',
    telegramMenu: false,
  ...
  },
  {
    ...
    prefix: '.',
    title: 'Режим паники',
    description: 'Экстренная локальная очистка архива текущего чата в SerkoGram',
    category: 'utility',
    usage: '.panic',
    example: '.panic',
    enabled: true,
