...
export const UNIFIED_COMMANDS: UnifiedCommandDefinition[] = [
  ...
  },
  {
    ...
    prefix: '.',
    title: 'Сердечки',
    description: 'Оформление текста сердечками с анимацией пульсации',
    category: 'animations',
    usage: '.heart [текст]',
    example: '.heart Люблю',
    enabled: true,
  ...
  },
  {
    ...
    name: 'plove',
    prefix: '.',
    title: 'Пиксельный кролик',
    description: 'Пиксельный кролик с признанием и анимацией',
    category: 'animations',
    usage: '.plove [текст]',
    example: '.plove Ты лучший',
    enabled: true,
    requiresReply: false,
    requiresArguments: false,
    requiresConnection: false,
  ...
  },
  {
    ...
    description: 'Переворачивает текст вверх ногами (русский и английский)',
    category: 'fun',
    usage: '.flip <текст>',
  ...
  },
  {
    ...
    name: 'bubble',
    prefix: '.',
    title: 'Текст в кружках',
    description: 'Оформляет символы текста в стильные кружки',
    category: 'fun',
    usage: '.bubble <текст>',
  ...
  },
  {
    ...
    name: 'spoiler',
    prefix: '.',
    title: 'Скрытый спойлер',
    description: 'Отправляет скрытый интерактивный текст спойлера Telegram',
    category: 'utility',
    usage: '.spoiler <текст>',
    example: '.spoiler Секретный пароль',
    enabled: true,
    requiresReply: false,
    requiresArguments: true,
    requiresConnection: false,
  ...
  },
  {
    ...
    name: 'dumb',
    prefix: '.',
    title: 'Саркастичный шрифт',
    description: 'Чередует прописные и строчные буквы текста',
    category: 'fun',
    usage: '.dumb <текст>',
    example: '.dumb Я очень умный',
    enabled: true,
    requiresReply: false,
    requiresArguments: true,
    requiresConnection: false,
  ...
  },
  {
    ...
    name: 'leet',
    prefix: '.',
    title: '1337 хакерский текст',
    description: 'Заменяет буквы на похожие цифры в стиле Leetspeak',
    category: 'fun',
    usage: '.leet <текст>',
    example: '.leet hacker elite',
    enabled: true,
    requiresReply: false,
    requiresArguments: true,
    requiresConnection: false,
  ...
  },
  {
    ...
    name: 'zalgo',
    prefix: '.',
    title: 'Zalgo проклятый текст',
    description: 'Добавляет диакритические символы хаоса с контролем размера',
    category: 'fun',
    usage: '.zalgo <текст>',
    example: '.zalgo проклятие',
    enabled: true,
    requiresReply: false,
    requiresArguments: true,
    requiresConnection: false,
